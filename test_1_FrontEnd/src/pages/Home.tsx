...
function Home() {
  ...
  const formatDate = (dateString: string) => {
    const dateTemplate = new Date(dateString);
    const day = String(dateTemplate.getDate()).padStart(2, "0");
    const month = String(dateTemplate.getMonth() + 1).padStart(2, "0");
    const year = dateTemplate.getFullYear();
  ...
  return (
    <>
      <Header
        title={user ? `Welcome, ${user.Name}` : "Loading user information..."}
        subtitle="PROFILE"
        user={user}
